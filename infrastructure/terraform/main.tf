...
# ─── S3 Bucket: Media / CDN files ───────────────────────────────────────────

resource "aws_s3_bucket" "media" {
  bucket = "${var.cdn_subdomain}-${replace(var.domain_name, ".", "-")}-media"
}
...
# ─── S3 Bucket: App static files ────────────────────────────────────────────

resource "aws_s3_bucket" "app" {
  bucket = "${var.app_subdomain}-${replace(var.domain_name, ".", "-")}-app"
}
